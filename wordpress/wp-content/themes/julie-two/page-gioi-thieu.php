  ...
  <div class="row">
    <div class="col-md-6 aos-init aos-animate" data-aos="fade-right">
      ...
      <p>
        ...
        vòi & phụ kiện nhựa ở Châu Á. Vòi nhựa của Watertec được làm bằng nhựa cao cấp đã qua xử lý với bảo hành lên đến
        10 năm.
        Sản lượng sản xuất hơn 6 triệu đơn vị hàng năm. Sản phẩm của Watertec hiện diện tại các nước ASEAN, Trung Đông
        và châu Phi.
        Watertec đang dẫn đầu thị trường van, vòi & phụ kiện nhựa ở Sri Lanka, Philippines, Việt Nam, Bangladesh,
        Indonesia, Ấn Độ, Jordan, Lebanon, Qatar,
        Ả Rập Saudi, Kenya và nhiều người khác. Hiện tại, Watertec là nhà sản xuất van, vòi và phụ kiện nhựa lớn nhất
        trên thế giới.
    ...
    <div class="col-md-6 aos-init aos-animate" data-aos="fade-left">
      <img style="width: 100%" class="img-responsive img-fluid my-3"
        src="<?php echo get_template_directory_uri(); ?>/img/slider11.jpg" alt="ve phan khang home">
=======
  <br/>
  <br/>
  <div class="row">
...
<<<<<<< HEAD
    <p>Mọi khách hàng đến với chúng tôi đều cảm thấy hài lòng và vô cùng tin tưởng với chất lượng,dịch vụ mà chúng tôi
      mang lại .</p>
